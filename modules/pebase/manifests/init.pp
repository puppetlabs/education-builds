class pebase {
  ...
  #  command => '/usr/bin/curl -so /root/puppet-enterprise-2.0.1-el-5-i386.tar.gz http://pm.puppetlabs.com/puppet-enterprise/2.0.1/puppet-enterprise-2.0.0-el-5-i386.tar.gz',
